...
ExportResult MK64::UnkSpawnDataHeaderExporter::Export(std::ostream& write, std::shared_ptr<IParsedData> raw,
...
ExportResult MK64::UnkSpawnDataCodeExporter::Export(std::ostream& write, std::shared_ptr<IParsedData> raw,
                                                    std::string& entryName, YAML::Node& node,
                                                    std::string* replacement) {
...
ExportResult MK64::UnkSpawnDataBinaryExporter::Export(std::ostream& write, std::shared_ptr<IParsedData> raw,
                                                      std::string& entryName, YAML::Node& node,
                                                      std::string* replacement) {
    auto spawns = std::static_pointer_cast<UnkSpawnDataData>(raw)->mSpawns;
...
std::optional<std::shared_ptr<IParsedData>> MK64::UnkSpawnDataFactory::parse(std::vector<uint8_t>& buffer,
    ...
    for (size_t i = 0; i < count; i++) {
        ...
        spawns.push_back(MK64::UnkActorSpawnData({ x, y, z, someId, unk8 }));
    }
